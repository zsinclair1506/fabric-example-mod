...
public enum ModArmorMaterials implements ArmorMaterial {
    CHROMIUM("chromium", 22, new int[]{3, 6, 7, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON,
            1.0F, 0.025F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.CHROMIUM_INGOT});
    }),
    ACTIVATED_TECHNETIUM("activated_technetium", 40, new int[]{4, 7, 9, 4}, 20, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
            4.0F, 0.25F, () -> {
